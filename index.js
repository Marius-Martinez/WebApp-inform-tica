function canvia_seccio(num_boto) {
    ...
    for (let i = 1; i < num_botons; i++) {
        ...
        if (i == num_boto) {
            boto.style.color = "#3355FF";    // es destaca la secció activa amb el canvi de colors del botó corresponent
            ...
            boto.style.backgroundColor = "#3355FF";
...
let nom, contrasenya;
let scriptURL = "https://script.google.com/macros/s/AKfycbwttFHicTez-rCGEEGfFZqJnGzGpmDjTT1-yJOA8Pn4qWqqB61Iz6FBwf4uJtXMI8QXeg/exec";    // s'ha de substituir la cadena de text per la URL del script
...
window.onload = () => { 
    let base_de_dades = sessionStorage.getItem("base_de_dades");   
    if(base_de_dades == null) {
        ...
        sessionStorage.setItem("base_de_dades","ok");
    }
